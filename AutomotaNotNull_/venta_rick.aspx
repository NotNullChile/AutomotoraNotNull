<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="venta_rick.aspx.cs" Inherits="AutomotaNotNull_.venta_rick" %>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="idVenta" DataSourceID="DSVentaVehiculo" DefaultMode="Insert" Height="50px" Width="228px" style="margin-right: 0px">
            <Fields>
                ...
                <asp:TemplateField HeaderText="Valor Venta" SortExpression="valorVenta">
                    ...
                    <InsertItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("idVenta") %>' TextMode="Number"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Ingrese valor de Venta" ForeColor="Red"></asp:RequiredFieldValidator>
                    </InsertItemTemplate>
                    <ItemTemplate>

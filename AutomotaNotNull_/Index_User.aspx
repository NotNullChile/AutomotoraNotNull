<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Index_User.aspx.cs" Inherits="AutomotaNotNull_.Index_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    ...
    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="padding:80px; padding-top:20px">
        <div class="btn-group" role="group">
            <a href="Ingreso_Vehiculo.aspx" class="btn btn-default" style="height:120px"><h4>Registrar Vehículos</h4> <br /><i class="fa fa-registered fa-3x"></i></a>
        </div>
        <div class="btn-group" role="group">
            <a href="Mi_Perfil.aspx" class="btn btn-default" style="height:120px"><h4>Ver mi Perfil</h4> <br /><i class="fa fa-user fa-3x"></i></a>
        </div>
        <div class="btn-group" role="group">
            <a href="Logout.aspx" class="btn btn-default" style="height:120px"><h4>Cerrar Sesión</h4> <br /><i class="fa fa-close fa-3x"></i></a>
        </div>
    </div>
        </div>
</asp:Content>
